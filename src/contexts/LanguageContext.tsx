...
const translations = {
  ...
  es: {
    ...
    'auth.description': 'Crea una cuenta para guardar tus comandas procesadas y acceder a ellas desde cualquier dispositivo.',
    ...
    'auth.featureComingSoon': '¡Esta función estará disponible pronto!',
